...
net_file = './RFB_320.prototxt'
caffe_model = './RFB_320.caffemodel'
...
def postprocess(out, img_h, img_w):
    ...
    output = []
    output.append(out['317'].reshape((-1)))
    output.append(out['331'].reshape((-1)))
    output.append(out['363'].reshape((-1)))
    output.append(out['377'].reshape((-1)))
    output.append(out['403'].reshape((-1)))
    output.append(out['417'].reshape((-1)))
    output.append(out['435'].reshape((-1)))
    output.append(out['447'].reshape((-1)))
    priorbox_index = -4
